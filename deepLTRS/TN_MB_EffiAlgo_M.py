...
# np.save('best_muV', best_muV)
# np.save('best_muW', best_muW)
...
import numpy as np
## load data
muV = np.load('C:/Users/Dingge/Doctoral_projets/Pytorch/best_muV.npy')
muW = np.load('C:/Users/Dingge/Doctoral_projets/Pytorch/best_muW.npy') 
# muV = np.load('C:/Users/Dingge/Downloads/script/best_muV3.npy')
# muW = np.load('C:/Users/Dingge/Downloads/script/best_muW3.npy') 
...
plt.show()
# f.savefig("C:/Users/Dingge/Doctoral_projets/Pytorch/visu_simu.pdf", bbox_inches='tight')
